...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_lidar_test_1_exec = my_robot_control.my_robot_lidar_test_1:main',
            ...
            'my_robot_wallfollower_diferencial_exec = my_robot_control.my_robot_wallfollower_diferencial:main',
